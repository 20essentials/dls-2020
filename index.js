...
const nameBand = 'DREAM LEAGUE SOCCER 2020';

const nameSongs = [
	"WE ARE TIME", /*1) (8.4/10)*/
	"NEVER GONNA GIVE IT UP", /*2*/
	"GLARING YOUTH", /*3) (8.6/10)*/
	"HEROES", /*4*/
	"STRIKE", /*5*/
	"EIGHTEEN", /*6*/
	"NOT GIVIN' YOU UP", /*7*/
	...
	"UR THE PARTY", /*11*/
	"GIVING UP", /*12*/
	"WE ARE TIME FT. HENDRICK", /*13*/
	"GHOSTING", /*14*/
	"WE ARE TIME FT. MAZEMIRROR", /*15*/
	"BROKEN GLASS", /*16*/
	"CRISIS", /*17*/
	"SECRET RIVALS", /*18*/
	"HELL BELOW", /*19*/
